...
struct nes_cartridge_t {
	...
	/* -- Mapper Callbacks -- */
	nes_cartridge_read_t cpu_reader; /**< Method to read from cartridge */
	nes_cartridge_write_t cpu_writer; /**< Method to write into cartridge */
	nes_cartridge_loader_t cpu_loader; /**< Method to load data into cartridge */
};
